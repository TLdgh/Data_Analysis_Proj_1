...
ggplot(poll_by_time, aes(x = end_time)) +
  ...
  scale_x_datetime(date_breaks = "2 month") +
   theme_minimal() + 
  ggtitle("Average Poll Proportion by Time 
          (with Missing Values)")
```
...
ggplot(poll_by_time_clean_3, aes(x = end_time_clean_3)) +
  ...
  scale_x_datetime(date_breaks = "2 month") +
  theme_minimal() +
  ggtitle("Clinton vs. Trump vs. Johnson Average Poll Proportion by Time 
          (without Missing Values)")
```
...
ggplot(poll_by_time_clean_2, aes(x = end_time_clean_2)) +
  ...
  scale_x_datetime(date_breaks = "2 month") +
  theme_minimal() + 
  ggtitle("Clinton vs. Trump Poll Average Proportion by Time 
          (without Missing Values)")
```
