...
shots<-webshot(url = "./Figures/popChart.html", file = "./Figures/popChart.png", delay = 1, zoom = 1, vheight = 350, vwidth = 950)
```
...
```{r, warning=FALSE, out.width="100%", out.height="30%", fig.cap = "Raw Poll Proportion by Time"}
