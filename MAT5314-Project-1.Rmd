...
```{r, warning=FALSE, fig.cap = "Raw Poll Proportion by Time.", fig.width=6, fig.height=4}
...
```{r, fig.cap = "Poll Percentage by States.", fig.width=6, fig.height=4}
...
![Map Chart of Election Result 2016](./Figures/mapchart3.png){width=70%, height=70%}
