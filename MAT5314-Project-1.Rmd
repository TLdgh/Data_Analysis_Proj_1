...
mapchart_1_2<-subplot(mapchart1, mapchart2)%>%
  layout(title = 'Clinton and Trump Predicted Vote Share in 2016 Election',
         annotations=list( 
           list( 
             x = 0.2,  
             y = 0.85,  
...
shots<-webshot(url = "./Figures/mapchart_1_2.html", file = "./Figures/mapchart_1_2.png", delay = 3, zoom = 2, vheight = 600)
```
...
poll_gap<-poll_gap%>%group_by(state)%>%summarize(gap=sum(gap))%>%
  transmute(State=state, PredictedResult=ifelse(gap>0, "T", "C"))
...
mapchart_3_4<-subplot(mapchart3, mapchart4)%>%
  layout(title = 'Clinton and Trump Vote Share in 2016 Election',
         annotations=list( 
           list( 
             x = 0.2,  
             y = 0.85,  
...
shots<-webshot(url = "./Figures/mapchart_3_4.html", file = "./Figures/mapchart_3_4.png", delay = 4, zoom = 2, vheight = 600)
```
