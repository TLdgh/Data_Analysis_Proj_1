...
mapchart1<-plot_geo(df3, locationmode = 'USA-states')%>% 
  add_trace(z = ~percent_rawpoll_clinton, locations = ~Code, color =~percent_rawpoll_clinton, colors=c('red','white','blue'),
...
mapchart2<-plot_geo(df_3, locationmode = 'USA-states')%>% 
  add_trace(z = ~percent_adjpoll_clinton, locations = ~Code, color =~percent_adjpoll_clinton, colors=c('red','white','blue'),showscale=FALSE)%>%
  add_trace(type = "scattergeo", locationmode = 'USA-states', locations = ~Code, 
            text = ~Code, mode = "text", textfont = list(size = 10))%>%
  layout(geo = g)
...
htmlwidgets::saveWidget(widget = mapchart, file = "mapchart.html") 
webshot::webshot(url = "mapchart.html", file = "mapchart.png", delay = 1, zoom = 4, vheight = 600)
```
...
htmlwidgets::saveWidget(widget = cMeanchart, file = "cMeanchart.html") 
webshot::webshot(url = "cMeanchart.html", file = "cMeanchart.png", delay = 1, zoom = 4, vheight = 600)
```
